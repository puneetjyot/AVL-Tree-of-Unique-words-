import java.util.LinkedList;
	public class AvlTree<AnyType extends Comparable<? super AnyType>> {
		...
		public void insert(AnyType x,int count) {
		...
		private AvlNode<AnyType> insert( AnyType x, AvlNode<AnyType> t,int count )
		    {
		        if( t == null )
		            return new AvlNode<AnyType>( x, null, null,count );
		...
		class AvlNode<AnyType> {
			// Constructors
			AvlNode( AnyType theElement, LinkedList<Integer> n,int count)
		        {
		            this( theElement, null, null,count);
		            
		        }
			
			
		/**	public String toString() {
				return "AvlNode [element=" + element + ", left=" + left + ", right=" + right + ", height=" + height
						+  "]";
			}**/
			

			AvlNode(AnyType theElement, AvlNode<AnyType> lt, AvlNode<AnyType> rt,int count) {
				element = theElement;
				left = lt;
				right = rt;
				height = 0;
